...
class ElRegistroCuadraConLasMemorias(unittest.TestCase):
    ...
    def test_ninguna_memoria_se_queda_fuera(self):
        ...
        fuera = sorted(self.memorias - self.slugs)
        self.assertEqual(fuera, [], "memorias `feedback` sin clasificar en el registro: %s" % fuera)
    ...
    def test_el_conteo_no_es_una_resta(self):
        ...
        self.assertGreaterEqual(e["en_registro"], e["memorias_feedback"],
