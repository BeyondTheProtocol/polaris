...
# pero no caza el contexto: "forense-pericial" no dice nada prohibido y aun así
# cuenta que hay un caso de acoso abierto. Estos salen como "comité" a secas.
# La lista es una PROPUESTA: la última palabra sobre qué se enseña es de {{TITULAR}}.
PUBLICO_RESERVADO = frozenset({
    "forense-pericial",   # delata el caso de acoso
...
# a un comité que delata el caso de acoso.
#
...
def limpiar(texto, cara, reserva="(reservado)"):
    ...
    try:
        ...
        return reserva
    return reserva if avisos else texto
