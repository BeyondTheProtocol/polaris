...
def main():
    ...
    # Tope de respuesta explícito (22-sep-26): sin él, algunos proveedores de la pasarela piden
    # TODO el contexto como salida y rechazan la petición (qwen3-235b: 504 + 131072 > 131072).
