...
RE_CITA = re.compile(r"\b(cita|appointment|schedul|reschedul|fecha|deadline|due\s+date|"
                     r"firma|sign|consent|washout|resultado|results)\b", re.I)
...
def es_ned_critico(sender="", subject=""):
    ...
    return any(k in t for k in NED_CRITICOS)
...
# egarante.com (evidencia de acoso, sensible) JAMÁS se trata como ruido.
