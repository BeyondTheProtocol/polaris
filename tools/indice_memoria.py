...
TEMAS = [
    ("muro", "🧱 Muro, seguridad y privacidad",
     ["muro", "seguridad", "privacidad", "egress", "secreto", "inyeccion", "acoso",
      "reidentificacion", "codigo-rojo", "proteger-goal", "clinico-en-historial",
      "censurar", "barrido", "verificacion", "pericial", "forense"]),
    ...
    ("redes", "📣 Redes, prensa y contactos",
     ["redes", "prensa", "contacto", "contactos", "dossier", "dm", "instagram",
      ...
      "realtitular", "bernardo", "contacto", "contacto", "alby", "contacto"]),
    ...
    ("coste", "💸 Coste, modelos y herramientas de IA",
     ["coste", "gasto", "token", "tokens", "credito", "modelo", "ultracode",
      ...
      "desacoplar", "herramientas-externas", "elicit", "baifo", "fugu", "helmcode",
